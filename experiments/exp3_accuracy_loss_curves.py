...
"""
实验3: 精度和损失曲线对比
绘制resnet50, vgg16, lstm, gpt2-medium在不同压缩算法下的精度和损失曲线
每个模型生成一张精度图和一张损失图
"""
...
def run_experiment(model_config, compressor_config, log_dir='./logs/exp3'):
    """运行单个实验"""
...
def main():
    ...
    print("="*80)
    print("1. 生成可视化:")
    print(f"   python experiments/visualize_exp3.py --log-dir {log_dir}")
    print("="*80 + "\n")
